...
,
  ...
  {
    id: 87,
    question: "Solve for x: 3(x + 2) = 2(2x + 5).",
    options: ["1", "4", "-1", "2"],
    correctAnswer: 0,
    difficulty: "difficult",
    type: "algebra",
    reward: 8,
    hint: "Expand both sides, collect terms."
  },
  {
    id: 88,
    question: "If 2x - (x/2) = 9, what is x?",
    options: ["6", "9", "4", "8"],
    correctAnswer: 3,
    difficulty: "difficult",
    type: "algebra",
    reward: 8,
    hint: "Multiply through by 2 to clear the fraction."
  },
  {
    id: 89,
  ...
  },
  {
    ...
    options: ["2/5", "1/5", "3/10", "4/5"],
    correctAnswer: 0,
    difficulty: "easy",
    type: "fractions",
    reward: 3,
    hint: "Subtract numerators, same denominator."
  },
  {
    id: 92,
    question: "Which is larger: 1/3 or 1/4?",
    options: ["1/3", "1/4", "They are equal", "Depends"],
    correctAnswer: 0,
    difficulty: "easy",
    type: "fractions",
    reward: 3,
    hint: "Smaller denominator means larger fraction if numerator is same."
  },
  {
    id: 93,
    question: "Simplify: 4/6.",
    options: ["2/3", "4/6", "1/3", "3/4"],
    correctAnswer: 0,
    difficulty: "moderate",
    type: "fractions",
    reward: 5,
    hint: "Divide numerator and denominator by common factor."
  },
  {
    id: 94,
    question: "What is 2/3 × 3/4?",
    options: ["1/2", "1/3", "2/7", "3/4"],
    correctAnswer: 0,
    difficulty: "moderate",
    type: "fractions",
    reward: 5,
  ...
  {
    id: 96,
    question: "Add: 3/4 + 5/6.",
    options: ["19/12", "8/10", "1", "7/12"],
    correctAnswer: 0,
    difficulty: "difficult",
    type: "fractions",
    reward: 8,
    hint: "Common denominator 12."
  },
  {
    id: 97,
    question: "Simplify and solve: (2/3)x = 8.",
    options: ["12", "10", "16", "4"],
    correctAnswer: 0,
    difficulty: "difficult",
    type: "algebra",
  ...
  {
    id: 98,
    question: "Subtract: 7/8 - 3/10.",
    options: ["29/40", "4/18", "1/8", "11/40"],
    correctAnswer: 0,
    difficulty: "difficult",
    type: "fractions",
    reward: 8,
    hint: "Common denominator 40."
  }
]];
